...
const TRAINING_COPY = {
  ...
  ar: {
    ...
    heroDescription:
      "تصمم شركة الدقة حلولاً تدريبية غامرة قائمة على التطبيق العملي والمحاكاة الواقعية. من إدارة المخاطر إلى تطوير رأس المال البشري، نمكّن الفرق من تبني عقليات جديدة وتحقيق أثر ملموس.",
    highlights: [
      {
        title: "رسالتنا",
        icon: Target,
