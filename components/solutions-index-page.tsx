      ...
      <div className="bg-white text-gray-900">
        <section className="relative overflow-hidden bg-[#0c0805] py-28 text-white">
          ...
          <div className={`relative mx-auto max-w-5xl px-8 ${isArabic ? "text-right" : "text-center"}`}>
            <p className={`text-xs uppercase tracking-[0.35em] text-[#d4af37] ${isArabic ? "arabic" : ""}`}>{copy.label}</p>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {localizedSolutions.map((solution) => (
                ...
                >
                  ...
                  <div
                    className={`flex items-center justify-between text-xs uppercase tracking-[0.3em] text-[#8b7355] ${
                  ...
                  <p className={`mt-4 text-xs font-light uppercase tracking-[0.3em] text-[#d4af37] ${isArabic ? "arabic" : ""}`}>
                    {copy.explore}
                  </p>
                </Link>
              ))}
