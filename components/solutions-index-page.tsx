...
> = {
  ...
  ar: {
    ...
    description:
      "نمزج بين استراتيجيات المنتجات، والتصميم المكاني، والذكاء الاصطناعي، وعمليات الصناعة لنقدّم حلولاً تحقق مؤشرات أداء حاسمة. تصفّح محفظة االحلول حسب المسار لمعرفة كيف نفعّل الخرائط التنفيذية عبر الحكومة، والرعاية الصحية، والقطاعات المؤسسية.",
            ...
            <div className={`flex flex-col gap-6 md:flex-row md:items-center md:justify-between`}>
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-neutral-600">
                  {language === "ar"
                    ? "صفّ االحلول حسب المسار لرؤية الخبرات المتخصصة والبيئات التي نقدّمها."
